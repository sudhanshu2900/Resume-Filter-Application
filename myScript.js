...
var size_requiredArr = requiredArr.length;

if(minReqSkills != 0 && n != 0 && size_requiredArr > 1 && minReqSkills <= size_requiredArr){
	document.write("<br>");
	...
	document.write("&#129318;&#127995 ! ERROR ! &#129318;&#127995");
	document.write("<br>");
	document.write("<br>");
	document.write("<br>");
	document.write("Please Enter above valid entries");
	document.write("<br>");
	document.write("<br>");
	document.write("Please check either you are not fill proper numbers of skills or minimum required skills or skills.");
	document.write("<br>");
	document.write("Or may be check that you should enter less skills then minimum required.");
}
